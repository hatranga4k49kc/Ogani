        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="/frontend/img/categories/cat-2.jpg">
                            <h5><a href="#">Dried Fruit</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="/frontend/img/categories/cat-3.jpg">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="/frontend/img/categories/cat-5.jpg">
                            <h5><a href="#">drink fruits</a></h5>
                        </div>
                    </div>
                </div>
...
{{--                            <li data-filter=".fastfoos">Fastfood</li>--}}
{{--                            <li data-filter=".vegetables">Vegetables</li>--}}
{{--                            <li data-filter=".abcd">Fastfood</li>--}}
{{--                            @foreach($categories as $category)--}}
{{--                            <li data-filter=".{{ asset('abc' . $category->id) }}">{{$category->name}}</li>--}}
{{--                            @endforeach--}}
{{--                        </ul>--}}
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix  ">
                    <div class="featured__item">
                        <form role="form" method="post" >
                            ...
                            <div class="featured__item__pic set-bg" data-setbg="{{ asset('frontend/img/product/' . $product->image) }}" width="150" height="150">
                                <ul class="featured__item__pic__hover">
                                    <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                    <li><a class="add-to-cart" type="button" name="add-to-cart" data-id_product ="{{$product->id}}"><i class="fa fa-shopping-cart"></i></a></li>
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="col-lg-3 col-md-4 col-sm-6 mix abcd fresh-meat">--}}
{{--                    <div class="featured__item">--}}
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges abcd">--}}
{{--                    <div class="featured__item">--}}
